<?php
    ...
    if($QrCodeType == "lien") { $QRmessage = 'Lien';}
    if($QrCodeType == "mail") { $QrText = "mailto:".$QrText; $QRmessage = 'Mail';}
    if($QrCodeType == "telephone") { $QrText = "tel:".$QrText; $QRmessage = 'Téléphone';}

    require "vendor/autoload.php";
    session_start();
    // $imageID = 55;
    $imageID = $_POST['QR-id'];
    // $imageID = isset($_POST['QR-id']) && $_POST['QR-id'] != 0 ? $_POST['QR-id'] : 1000;
