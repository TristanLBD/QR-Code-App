<?php
    if(!isset($_POST['QR-wifi'],$_POST['QR-wifi-password'],$_POST['QR-hidden'],$_POST['QR-encryption'])) { 
    ...
    // $qrCode = new Lien(['db'=>$DB, 'link' => "https://www.youtube.com",'id' => $_SESSION['id']]);
...
$qr_code = QrCode::create("WIFI:S:" . $_POST['QR-wifi'] . ";T:" . $_POST['QR-encryption'] . ";P:" . $_POST['QR-wifi-password'] . ";H:" . ($_POST['QR-hidden'] == "oui" ? 'true': 'false') . ";;")
    ->setSize($QRSize)
    ->setMargin($QRMargin)
    ...
    $response['message'] = "Wifi correctement générée.";
